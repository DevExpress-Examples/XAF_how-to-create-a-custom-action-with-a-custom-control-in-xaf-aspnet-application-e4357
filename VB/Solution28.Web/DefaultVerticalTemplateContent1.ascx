<%@ Control Language="vb" CodeBehind="DefaultVerticalTemplateContent1.ascx.vb" ClassName="DefaultVerticalTemplateContent1" Inherits="Solution28.Web.DefaultVerticalTemplateContent1" %>
							...
							<tr>
								...
								<td class="Security">
									<cc3:XafUpdatePanel ID="UPSAC" UpdatePanelForASPxGridListCallback="False" runat="server">
										<ccmy:MyActionContainerHolder runat="server" ID="SAC" CssClass="Security" 
							...
							<tr class="Content">
								<td class="Content WithPaddings" align="right">
									<cc3:XafUpdatePanel ID="UPSHC" runat="server" UpdatePanelForASPxGridListCallback="False">
										<ccmy:MyActionContainerHolder ID="SHC" runat="server"
								...
								<div id="LP" class="LeftPane">
									...
									<cc3:XafUpdatePanel ID="UPTP" runat="server">
										<div id="TP" runat="server" class="ToolsActionContainerPanel">
											<dx:ASPxRoundPanel ID="TRP" runat="server" HeaderText="Tools" CssClass="TRP" Width="170px">
												<panelcollection>
													<dx:PanelContent ID="PanelContent1" runat="server">
														<ccmy:MyActionContainerHolder ID="VTC" runat="server" Menu-Width="100%" 
											...
											<ccmy:MyActionContainerHolder ID="DAC" runat="server" Orientation="Vertical"
										...
										<tr>
											<td>
												<cc3:XafUpdatePanel ID="UPTB" runat="server">
													<ccmy:MyActionContainerHolder CssClass="ACH MainToolbar" runat="server" ID="TB" ContainerStyle="ToolBar" Orientation="Horizontal">
										...
										<tr>
											<td>
												<cc3:XafUpdatePanel ID="UPEMA" runat="server" UpdatePanelForASPxGridListCallback="False">
													<ccmy:MyActionContainerHolder runat="server" ID="EMA" ContainerStyle="Links" Orientation="Horizontal" CssClass="EditModeActions">
														<Menu Width="100%" ItemAutoWidth="False" HorizontalAlign="Right" />
															<ActionContainers>
