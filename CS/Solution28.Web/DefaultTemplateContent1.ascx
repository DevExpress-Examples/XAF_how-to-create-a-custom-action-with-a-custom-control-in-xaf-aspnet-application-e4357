                            ...
                            <tr>
                                ...
                                <td class="Security">
                                    <cc3:XafUpdatePanel ID="UPSAC" runat="server" UpdatePanelForASPxGridListCallback="False">
                                        <ccmy:MyActionContainerHolder runat="server" ID="SAC" ContainerStyle="Links" CssClass="Security" ShowSeparators="True" >
                                            <ActionContainers>
                        ...
                        <cc3:XafUpdatePanel ID="UPNTAC" UpdatePanelForASPxGridListCallback="False" runat="server">
                            <cc2:NavigationTabsActionContainer ID="NTAC" runat="server" ContainerId="ViewsNavigation"
                                ...
                                <spaceaftertabstemplate>
                                    <ccmy:MyActionContainerHolder ID="VN" runat="server" ContainerStyle="Links" CssClass="TabsContainer">
                                        <ActionContainers>
                            ...
                            <td id="LPcell" style="width: 200px; vertical-align: top;">
                                <div id="LP" class="LeftPane" style="width: 200px;">
                                    <cc3:XafUpdatePanel ID="UPLP" runat="server">
                                        <ccmy:MyActionContainerHolder ID="VTC" runat="server" Orientation="Vertical"
