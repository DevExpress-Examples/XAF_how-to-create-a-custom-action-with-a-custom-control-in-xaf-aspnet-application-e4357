<%@ Control Language="C#" CodeBehind="DefaultVerticalTemplateContent1.ascx.cs" ClassName="DefaultVerticalTemplateContent1" Inherits="Solution28.Web.DefaultVerticalTemplateContent1" %>
